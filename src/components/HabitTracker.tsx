...
import { Plus, Flame, Target, Trash2, TrendingUp, Calendar } from 'lucide-react';
...
export const HabitTracker = ({ habits, setHabits }: HabitTrackerProps) => {
  ...
  // Sort habits by completion status, then by streak
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex gap-2">
            ...
            <Button onClick={addHabit} className="bg-purple-600 hover:bg-purple-700 px-6">
